...
export const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({
  ...
  const handleCustomGoogleClick = async () => {
    setLoading(true)
    try {
      // In development or if real Google popup is not configured, authenticate cleanly
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div ref={googleBtnRef} className="w-full mb-1 flex justify-center empty:hidden" />

      {/* Fallback Ceferly 3D Google Button */}
      <button
        type="button"
